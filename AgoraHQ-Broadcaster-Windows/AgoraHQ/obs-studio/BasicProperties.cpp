...
CBasicProperties::CBasicProperties(UINT nIDTemplate, OBSSource _source, CWnd* pParent /*=NULL*/)
...
BOOL CBasicProperties::OnInitDialog()
{
	...
	preview->Create(NULL, NULL, WS_CHILD | WS_VISIBLE | WS_BORDER, CRect(10, 10, width - 20, height - 10 - m_dist_vertical), this, IDC_BASEWND_VIDEO + 100);
...
void CBasicProperties::AddDisplay()
{
	obs_display_add_draw_callback(preview->GetDisplay(), CBasicProperties::DrawPreview, this);
}
