...
// 	}
// 
// 	ret = GetConfigPath(path, sizeof(path), "tudouni/basic/scenes/");
// 	if (ret <= 0) {
...
// }
// 
void CAgoraHQDlg::RefreshSceneCollections()
{
...
//	}
	...
	const char *cur_name = config_get_string(theApp.GlobalConfig(),
...
// 
// 	char path[512];
// 	int ret = GetConfigPath(path, 512, "tudouni/basic/scenes/");
// 	if (ret <= 0) {
// 		blog(LOG_WARNING, "Failed to get scene collection config path");
// 		return;
// 	}
