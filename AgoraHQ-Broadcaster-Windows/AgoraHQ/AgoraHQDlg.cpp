...
// {
// 	CAgoraHQDlg* pThis = theApp.GetMainWindow();
// 
// 	uint32_t    cx = pThis->obs_output_x;
// 	uint32_t    cy = pThis->obs_output_y;
// 	memcpy(pThis->m_lpAgoraObject->m_videoObserver->m_lpImageBuffer, data, pThis->obs_output_x* pThis->obs_output_y * 3 / 2);
// }
// 
// void CAgoraHQDlg::obsAudioCallback(struct audio_data* data, int planes, void* param)
// {
// 	CAgoraHQDlg* pThis = theApp.GetMainWindow();
// 	int dataLen = data->frames * planes * 2;//2:16 int
// 	pThis->m_lpAgoraObject->m_audioObserver->pCircleBuffer->writeBuffer(data->data[0], dataLen);
// }
//end
...
void CAgoraHQDlg::SetupRempteVideo(long long  uid)
{
	SetPreviewPK(true);
	//obs_service_agora_setup_remote_video(agoraService, uid, (void*)remoteVideo->winId());
}

void CAgoraHQDlg::OnUserOffline(long long uid)
{
...
void CAgoraHQDlg::OnUserJoined(long long uid)
{
