...
void obs_encoder_add_agora_video_callback(obs_encoder_t* video_encoder, obsVideoCallback callback, void *param)
{
	if (video_encoder->info.set_agora_video_callback){
		video_encoder->info.set_agora_video_callback(callback, param);
	}
}

void obs_encoder_add_agora_audio_callback(obs_encoder_t* audio_encoder, obsAudioCallback callback, void *param)
{
	if (audio_encoder->info.set_agora_audio_callback){
		audio_encoder->info.set_agora_audio_callback(callback, param);
	}
}