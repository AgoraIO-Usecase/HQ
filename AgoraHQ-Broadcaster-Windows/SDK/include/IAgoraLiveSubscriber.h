        ...
        */
        ...
        public:
            ...
            * @param sync
            ...
            - true: Releases the engine resources and return after all resources have been destroyed. APP should try not to call release(true) in the engine's callbacks, call it this way in a separate thread instead.
