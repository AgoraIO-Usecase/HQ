...
import io.agora.livequiz.module.MyEngineEventHandler;
...
public abstract class BaseActivity extends Activity {
    ...
    protected void initConstantsHttp() {
        ...
        Constants.HTTP_CHECK_WHETHER_CAN_PLAY = getResources().getString(R.string.http_check_wheather_can_play);
        Constants.HTTP_REPLY_WHETHER_ACCEPT_VIDEO = getString(R.string.http_reply_wheather_accept_video);
      /*
        ...
        GameControl.logD(tag + "Http_Check_Whether_can_play = " + Constants.HTTP_CHECK_WHETHER_CAN_PLAY);
        GameControl.logD(tag + "Http_Check_Whether_can_play = " + Constants.HTTP_CHECK_WHETHER_CAN_PLAY);
*/
    }
}
