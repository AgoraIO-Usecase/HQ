package io.agora.livequiz.view;
...
import io.agora.livequiz.HqApplication;
import io.agora.livequiz.R;
import io.agora.livequiz.control.AgoraSignal;
import io.agora.livequiz.control.JsonToString;
import io.agora.livequiz.control.SendMessageHelper;
import io.agora.livequiz.control.WorkerThread;
import io.agora.livequiz.module.AGEventHandler;
import io.agora.livequiz.module.Question;
import io.agora.livequiz.module.Result;
import io.agora.livequiz.module.User;
import io.agora.livequiz.tools.Constants;
import io.agora.livequiz.tools.GameControl;
import io.agora.livequiz.tools.GangUpRecycleViewAdapter;
import io.agora.livequiz.tools.HttpUrlUtils;
import io.agora.livequiz.tools.MessageListDecoration;
import io.agora.livequiz.tools.MessageRecyclerViewAdapter;
            ...
            switch (msg.what) {
                ...
                case Constants.AGORA_SIGNAL_RECEIVE:
                    ...
                    switch (JsonToString.strinType) {
                        ...
                        case "chat":
                            io.agora.livequiz.module.Message message = (io.agora.livequiz.module.Message) jsonObject;
                ...
                case Constants.AGORA_SIGNAL_SEND:
                    ...
                    io.agora.livequiz.module.Message jsonObjects = null;
                    try {
                        jsonObjects = (io.agora.livequiz.module.Message) JsonToString.jsonToString(sendMessage);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    ...
                    io.agora.livequiz.module.Message message = new io.agora.livequiz.module.Message(sendName, content);
