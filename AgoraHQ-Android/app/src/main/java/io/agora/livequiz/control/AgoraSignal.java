...
public class AgoraSignal {
    ...
    public void sendChannelMessage(String message, String selfMessage) {
        ...
        if (agoraHQSigSDK != null) {
            ...
            if (selfMessage != null) {
                handlerEvent(io.agora.livequiz.tools.Constants.AGORA_SIGNAL_SEND, selfMessage);
            }
        }
    }
    ...
    public static void checkRelive(HttpUrlUtils.OnResponse callback) throws JSONException {
        ...
        utils.execHttpAsyncTask(io.agora.livequiz.tools.Constants.HTTP_RELIVE, true, callback, data);
    }
    ...
    public static void wheatherAcceptVideoWithBroadCast(boolean wheatherAccept, String account, String mediaUid, String channelName) {
        ...
        urlUtils.execHttpAsyncTask(Constants.HTTP_REPLY_WHETHER_ACCEPT_VIDEO, true, null, data);
        GameControl.logD(tag + "whetherAcceptVideoWithBroadCast  wheather  map =  " + data.toString());
    }
    ...
    public static void sendAnswerToserver(int sid, int result, HttpUrlUtils.OnResponse callback) throws JSONException {
        if (GameControl.serverWheatherCanPlay && GameControl.clientWheatherCanPlay) {
            ...
            HttpUrlUtils utils = new HttpUrlUtils();
            utils.execHttpAsyncTask(io.agora.livequiz.tools.Constants.HTTP_SEND_ANSWER_TO_SERVER, true, callback, data);
        }
    }

    public static void checkWheatherCanPlay(HttpUrlUtils.OnResponse callback) throws JSONException {
        String url = Constants.HTTP_CHECK_WHETHER_CAN_PLAY + GameControl.currentUser.getChannelName() + "&uid=" + GameControl.currentUser.getSignalAccount();
    ...
    class SignalEvent implements AgoraHQSigSDK.EventHandler {
        ...
        public void onLoginSuccess() {
            ...
            handlerEvent(io.agora.livequiz.tools.Constants.LOGIN_AGORA_SIGNAL_SUCCESS, 0);
        }

        @Override
        public void onError(int error) {
            GameControl.logD(tag + "onError");
            handlerEvent(io.agora.livequiz.tools.Constants.LOGIN_AGORA_SIGNAL_FAIL, error);
        }
        ...
        public void onChannelMessageReceived(final String channel, final long msgId, final String msg) {
            ...
            if (msg != null) {
                handlerEvent(io.agora.livequiz.tools.Constants.AGORA_SIGNAL_RECEIVE, msg);
            }
        }
