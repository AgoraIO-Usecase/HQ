...
//add by agora
typedef void(*AudioCallback)(struct encoder_frame* data, int planes, void* param);
typedef void(*VideoCallback)(uint8_t* data, void* param);
//end
...
struct obs_encoder_info {
	...
	// add by agora
// 	struct obs_encoder_agora_audio_callback agora_encoder_audio;
// 	struct obs_encoder_agora_video_callback agora_encoder_video;
	void(*agora_audio_encoder_callback)(struct encoder_frame* data, int planes, void* param);
	void(*agora_video_encoder_callback)(uint8_t* data, void* param);
	void* param;
	void(*set_agora_audio_callback)(AudioCallback callback, void* param);
	void(*set_agora_video_callback)(VideoCallback callback, void* param);
	// end
};
