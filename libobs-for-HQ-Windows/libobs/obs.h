...
//add by agora
typedef void(*obsVideoCallback)(uint8_t* data, void* param);
typedef void(*obsAudioCallback)(struct encoder_frame* data, int planes, void* param);

EXPORT void obs_encoder_add_agora_video_callback(obs_encoder_t* video_encoder, obsVideoCallback callback, void *param);
EXPORT void obs_encoder_add_agora_audio_callback(obs_encoder_t* audio_encoder, obsAudioCallback callback, void *param);
